  ...
  return (
    <tr className="border-b border-slate-100 last:border-0">
      <td className="px-4 py-2.5">
        <Link href={`/products/${product.slug}`} className="hover:text-[#0A6286]">
      ...
      <td className="px-4 py-2.5">
        <button
          onClick={save}
          disabled={!dirty || busy}
          className="flex items-center gap-1 text-xs font-semibold px-2.5 py-1.5 rounded-md bg-[#0A6286] text-white disabled:opacity-30"
        >
