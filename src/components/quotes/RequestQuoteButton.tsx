...
export default function RequestQuoteButton() {
  ...
  return (
    <button onClick={request} disabled={busy}
      className="w-full mt-2 flex items-center justify-center gap-2 border border-slate-300 bg-white text-slate-700 font-semibold py-2.5 rounded-lg text-sm hover:border-[#0A6286] hover:text-[#0A6286] disabled:opacity-60">
